...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.winnow_results = function() {
      var eregex, exact_result, found, option, part, parts, regex, regexAnchor, result, result_id, results, searchText, startpos, text, zregex, _i, _j, _len, _len2, _ref;
    ...
    Chosen.prototype.select_create_option = function(terms) {
      if ($.isFunction(this.create_option)) this.create_option.call(this, terms);
